...
Route::group(['namespace' => 'Frontend'], function(){
    ...
    Route::get('/list-doctors','HomeController@doctors')->name('list_doctors');
    Route::get('/list-articles','HomeController@articles')->name('list_articles');
...
Route::group(['middleware' => 'AuthMiddleware'], function(){
    ...
    Route::prefix('doctors')->group(function(){
        Route::get('/add', 'DoctorController@index');
        Route::post('/add', 'DoctorController@save');
        Route::post('/update', 'DoctorController@update');
        Route::get('/list', 'DoctorController@manage');
        ...
        Route::get('/activeStatus/{status}/{id}', 'DoctorController@activeStatus');
        Route::get('/editProfile/', 'DoctorController@editProfile');
