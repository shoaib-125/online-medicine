            ...
            <div class="col-lg-7">
                <div class="product-details-info pl-lg--30 ">
                    ...
                    <ul class="list-unstyled">
                        <li>Generic: <a href="#" class="list-value font-weight-bold"> {{$product->generic->name}}</a></li>
                        <li>Side Effects: {{$product->side_effects}}</li>
                        <li>Contradictions: {{$product->contradictions}}</li>
                        <li>Indications: {{$product->indications}}</li>
                        <li>Generic: <a href="#" class="list-value font-weight-bold"> {{$product->generic->name}}</a></li>
