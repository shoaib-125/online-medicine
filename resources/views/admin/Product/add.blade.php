    ...
    <div class="col-lg-12 centerDiv">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
              <label for="exampleInputSideEffects">Side Effects</label>
              <input name="side_effects" placeholder="Side Effects" class="form-control" value="{{isset($medicine) ? $medicine->side_effects :old('side_effects')}}" required>
          </div>

          <div class="form-group">
                <label for="exampleInputContradictions">Contradictions</label>
                <input name="contradictions" placeholder="Contradictions" class="form-control" value="{{isset($medicine) ? $medicine->contradictions :old('contradictions')}}"  required>
          </div>

          <div class="form-group">
            <label for="exampleInputIndications">Indications</label>
            <input name="indications" placeholder="Indications" class="form-control" value="{{isset($medicine) ? $medicine->indications :old('indications')}}"  required>
          </div>
...
@endsection
<script>
    import Index from "../../../../public/Backend/bower_components/Flot/examples/zooming/index.html";
    export default {
        components: {Index}
    }
</script>
