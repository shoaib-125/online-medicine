              ...
              <div class="box-body">
               ...
               <div class="attachment-pushed box-header with-border">
                ...
                <div class="attachment-pushed box-header with-border">
                  ...
                  <div class="attachment-pushed box-header with-border">
                      <h4 class="attachment-heading"><a>Side Effects</a></h4>
                      <div class="attachment-text">{{isset($medicine->side_effects) ? $medicine->side_effects : ''}}</div>
                  </div>

                  <div class="attachment-pushed box-header with-border">
                      <h4 class="attachment-heading"><a>Contradictions</a></h4>
                      <div class="attachment-text">{{isset($medicine->contradictions) ? $medicine->contradictions : ''}}</div>
                  </div>

                  <div class="attachment-pushed box-header with-border">
                      <h4 class="attachment-heading"><a>indications</a></h4>
                      <div class="attachment-text">{{isset($medicine->indications) ? $medicine->indications : ''}}</div>
                  </div>
