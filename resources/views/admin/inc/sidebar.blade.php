  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <li class="treeview">
            <a href="#">
                <i class="fa fa-user"></i><span>Doctor Management</span>
                <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="{{url('doctors/add')}}"><i class="fa fa-user-plus"></i> Add Doctor</a></li>
                <li><a href="{{url('doctors/list')}}"><i class="fa fa-list"></i>Doctor List</a></li>
            </ul>
        </li>

        <li class="treeview">
            <a href="#">
                <i class="fa fa-hospital-o"></i><span>Articles</span>
                <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
            </a>
            <ul class="treeview-menu">
                ...
                <li class="active"><a href="{{url('articles/add')}}"><i class="fa fa-plus"></i>Add Articles</a></li>
                <li class="active"><a href="{{url('articles/list')}}"><i class="fa fa-list"></i>Article List</a></li>
